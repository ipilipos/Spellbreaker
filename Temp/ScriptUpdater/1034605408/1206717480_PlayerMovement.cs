...
public class PlayerMovement : MonoBehaviour
{
    ...
    // Input variables - simplified
    // No jump or run input needed
    ...
    {
        // Ground check not needed for no-gravity game, but keeping for compatibility
    ...
    // Gizmos for debugging (simplified for no-gravity game)
